...
import edu.kit.informatik.structure.characters.monsters.one.Frog;
import edu.kit.informatik.structure.characters.monsters.one.Ghost;
import edu.kit.informatik.structure.characters.monsters.one.Gorgon;
import edu.kit.informatik.structure.characters.monsters.one.Skeleton;
import edu.kit.informatik.structure.characters.monsters.one.Spider;
import edu.kit.informatik.structure.characters.monsters.one.Goblin;
import edu.kit.informatik.structure.characters.monsters.one.Rat;
import edu.kit.informatik.structure.characters.monsters.one.Mushroomlin;
import edu.kit.informatik.structure.characters.monsters.two.Snake;
import edu.kit.informatik.structure.characters.monsters.two.DarkElf;
import edu.kit.informatik.structure.characters.monsters.two.ShadowBlade;
import edu.kit.informatik.structure.characters.monsters.two.Hornet;
import edu.kit.informatik.structure.characters.monsters.two.Tarantula;
import edu.kit.informatik.structure.characters.monsters.two.Bear;
import edu.kit.informatik.structure.characters.monsters.two.Mushroomlon;
import edu.kit.informatik.structure.characters.monsters.two.WildBoar;
